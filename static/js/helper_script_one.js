let select_players = function(team1,team2,mn,series_index,mode)
{
...
fi.src=`dream11_images\\${team_list[team1]}.jpg`;
si.src=`dream11_images\\${team_list[team2]}.jpg`;
...
submit_players.addEventListener('click',()=>
{
    ...
    if(team_one_cnt<7 || team_two_cnt<7){raiseError('you should select atleast 7 players from each team!'); return}
    ...
    sfp.addEventListener('click',()=>
    {
            ...
            if(fixed_team_one_players.length>7 || fixed_team_two_players.length>7){raiseError('you cannot select more than 7 palyers as fixed from one team!'); return}
                ...
                svcp.addEventListener('click',()=>
                {
                    ...
                    tsc.addEventListener('click',()=>
                    {
                        ...
                        crc.addEventListener('click',()=>
                        {
                            ...
                            team_generator(index_one,index_two,team1,team2,mn,csv,cev,fixed_team_one_players,fixed_team_two_players,captain_team_one_players,captain_team_two_players,vice_captain_team_one_players,vice_captain_team_two_players,selected_tsd,series_index,mode)
                        })
                    })
                })
    ...
    {
        mode_method(team1,team2,mn,index_one,index_two,series_index,mode)
    } 
})
