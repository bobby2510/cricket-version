...
ctc.addEventListener('click',()=>
{
    ...
    custom_comb.forEach((comb)=>
   {
    ...
    team_generator_helper_two(wk,bat,al,bowl,[],[],[],[],req_comb,0,1,nt,1,93,100,team_one_players,team_two_players,team_one_players,team_two_players,0,0,0,0,[0,1,2,3],1,1)
    })
})
