...
analytic.addEventListener('click',()=>
{
    ...
    display_analytics(mn,attempt_id,series_index)
})
let display_analytics = function(mn,attempt_id,series_index)
{
    ...
    data.attempts.forEach((attempt)=>
    {
        ...
        {
            display_analytics_helper(attempt,series_index);
        }
    })
}
let display_analytics_helper = function(attempt,series_index)
{
